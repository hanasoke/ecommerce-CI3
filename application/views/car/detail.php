		...
		<div class="container mb-4">
			<div class="row">
				<div class="col mt-3">
					<div class="card">
						<div class="card-body">
							<h1 class="card-title">Car Profile Detail</h1>
								<div class="mb-3 row">
									<label for="seller_name" class="col-sm-2 col-form-label">Name</label>
									<div class="col-sm-10">
										<input type="text" class="form-control-plaintext" name="seller_name" id="seller_name" value="#" />
									</div>
								</div>
								...
								<div class="mb-3 row">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control-plaintext" name="seller_email" id="seller_email" value="#"/>
									</div>
								</div>
								...
								<div class="mb-3 row">
									...
									<div class="col-sm-10">
										<input type="number" class="form-control-plaintext" disabled name="seller_phone" id="seller_phone" value="#" />
									</div>
								</div>
								...
								<div class="mb-3 row">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control-plaintext" name="seller_address" id="seller_address" value="#" />
									</div>
								</div>
